...
from app.config import BOT_TOKEN_SUPPLIES
...
async def main():
    ...
    bot = Bot(token=BOT_TOKEN_SUPPLIES)
    ...
    dp.message.middleware(StatsMiddleware(bot_name="stockbot2"))
    dp.callback_query.middleware(StatsMiddleware(bot_name="stockbot2"))
